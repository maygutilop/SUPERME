...
# USER
file = URI.open('https://w7.pngwing.com/pngs/985/915/png-transparent-superman-computer-icons-superhero-avatar-child-face-heroes.png')
user = User.create(username: "Super Moritz", email: "moritz@gmail.com", password: "123456")
...
# USERS
file = URI.open('https://toppng.com/uploads/preview/avatar-superheroes-11563239319awujxqtqc5.png')
user = User.create(username: "Super Mayra", email: "mayra@gmail.com", password: "123456")
user.photo.attach(io: file, filename: "#{user.username}.png", content_type: 'image/png')
...
# USERS
file = URI.open('https://media.istockphoto.com/vectors/girl-vector-id1220985230?b=1&k=20&m=1220985230&s=170667a&w=0&h=HQPCByAGriMnz-Na5eF3A9oUXDZ6JbrS7fqbGJ4pQz4=')
user = User.create(username: "Super Tamara", email: "tamara@gmail.com", password: "123456")
user.photo.attach(io: file, filename: "#{user.username}.png", content_type: 'image/png')
...
# USERS
file = URI.open('https://www.clipartmax.com/png/middle/169-1690318_super-hero-avatar-png.png')
user = User.create(username: "Super Manuela", email: "manuela@gmail.com", password: "123456")
user.photo.attach(io: file, filename: "#{user.username}.png", content_type: 'image/png')
...
# USERS
file = URI.open('https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/5bfc4f28230479.58e236bbeb88c.jpg')
user = User.create(username: "Super Cacique", email: "cacique@gmail.com", password: "123456")
user.photo.attach(io: file, filename: "#{user.username}.png", content_type: 'image/png')
...
file = URI.open('https://images-na.ssl-images-amazon.com/images/I/A1usoB30waL.jpg')
